...
import styles from './SectionThreeStudent.module.css'
  ...
  return (
    ...
    <section className={styles.sectionThreeExpert}>
            <div className="container">
                ...
                <img src="https://i.ibb.co/wpZTbjP/cheerful-attractive-young-woman-with-black-hair-walking.jpg" className='img-fluid' alt="" />
